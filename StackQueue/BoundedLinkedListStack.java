...
/**
 * 
 * Class to create a bounded stack with an underlying Linked List
 * 
 * @author Samson Haile
 * @version Standard
 * 
 * 
 */
public class BoundedLinkedListStack implements BoundedStack{
  ...
  public BoundedLinkedListStack(int i){
    length = i;
    size = 0;
    first = null;
    last = null;
   ...
   * Since this is a simple assignment operation, this is O(k).
